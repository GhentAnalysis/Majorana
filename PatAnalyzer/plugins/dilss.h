...
const char* _triggers3lNamesdilss[4] =
...
const char* _triggers2lNamesdilss[2][6] =
...
const char* _triggers2lNamesdilssBkp[2][6] =
...
const char* _triggersCSNamesdilss[5][5] =
{
...
const char* _triggersCSbNamesdilss[2] = {"HLT_Mu10_CentralPFJet30_BTagCSV0p5PF_v","HLT_Ele10_CaloIdM_TrackIdM_CentralPFJet30_BTagCSV0p5PF_v"};

const char* _triggers1lNamesdilss[5] =
...
class dilss : public edm::EDAnalyzer {
public:
    
    explicit dilss(const edm::ParameterSet & iConfig);
    ~dilss(){};
