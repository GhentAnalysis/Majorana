...
class trilSUSY : public edm::EDAnalyzer {
public:
    
    explicit trilSUSY(const edm::ParameterSet & iConfig);
    ~trilSUSY(){};
...
private:
    ...
    double _jetPt[20];
    double _jetM[20];
    double _jetFlavour[20];
    bool _bTagged[20];
    double _csv[20];

    double _jetDeltaR[20][nLeptonsMax];
    double _jetDeltaRloose[20];
    ...
    double _closeJetPtAll_unc[nLeptonsMax];
