...
const char* _triggers3lNames6[4] =
...
const char* _triggers2lNames6[2][6] =
...
const char* _triggers2lNames6Bkp[2][6] =
...
const char* _triggersCSNames6[5][5] =
{
...
const char* _triggersCSbNames6[2] = {"HLT_Mu10_CentralPFJet30_BTagCSV0p5PF_v","HLT_Ele10_CaloIdM_TrackIdM_CentralPFJet30_BTagCSV0p5PF_v"};

const char* _triggers1lNames6[5] =
...
class dilss13_1l : public edm::EDAnalyzer {
public:
    
    explicit dilss13_1l(const edm::ParameterSet & iConfig);
    ~dilss13_1l(){};
