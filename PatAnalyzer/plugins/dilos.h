...
const char* _triggers3lNamesdilos[4] =
...
const char* _triggers2lNamesdilos[2][6] =
...
const char* _triggers2lNamesdilosBkp[2][6] =
...
const char* _triggersCSNamesdilos[5][5] =
{
...
const char* _triggersCSbNamesdilos[2] = {"HLT_Mu10_CentralPFJet30_BTagCSV0p5PF_v","HLT_Ele10_CaloIdM_TrackIdM_CentralPFJet30_BTagCSV0p5PF_v"};

const char* _triggers1lNamesdilos[5] =
...
class dilos : public edm::EDAnalyzer {
public:
    
    explicit dilos(const edm::ParameterSet & iConfig);
    ~dilos(){};
