...
const char* _triggers3lNamesHadr[4] =
...
const char* _triggers2lNamesHadr[2][6] =
...
const char* _triggers2lNamesHadrBkp[2][6] =
...
const char* _triggersCSNamesHadr[5][5] =
{
...
const char* _triggersCSbNamesHadr[2] = {"HLT_Mu10_CentralPFJet30_BTagCSV0p5PF_v","HLT_Ele10_CaloIdM_TrackIdM_CentralPFJet30_BTagCSV0p5PF_v"};

const char* _triggers1lNamesHadr[5] =
...
class trilHadr : public edm::EDAnalyzer {
public:
    
    explicit trilHadr(const edm::ParameterSet & iConfig);
    ~trilHadr(){};
