...
class effFull : public edm::EDAnalyzer {
public:
    
    explicit effFull(const edm::ParameterSet & iConfig);
    ~effFull(){};
...
private:
    ...
    double _muonDpt[nLeptonsMax];

    bool _ICHEPsoftMuonId[nLeptonsMax];
    ...
    double _lPt[nLeptonsMax], _lEta[nLeptonsMax], _lPhi[nLeptonsMax], _lE[nLeptonsMax], _lpdg_truth[nLeptonsMax];
    double _lPt_truth[nLeptonsMax], _lEta_truth[nLeptonsMax], _lPhi_truth[nLeptonsMax], _lE_truth[nLeptonsMax];
