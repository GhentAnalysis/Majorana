...
const char* _triggers3lNamesEWK[4] =
...
const char* _triggers2lNamesEWK[2][6] =
...
const char* _triggers2lNamesEWKBkp[2][6] =
...
const char* _triggersCSNamesEWK[5][5] =
{
...
const char* _triggersCSbNamesEWK[2] = {"HLT_Mu10_CentralPFJet30_BTagCSV0p5PF_v","HLT_Ele10_CaloIdM_TrackIdM_CentralPFJet30_BTagCSV0p5PF_v"};

const char* _triggers1lNamesEWK[5] =
...
class trilEWK : public edm::EDAnalyzer {
public:
    
    explicit trilEWK(const edm::ParameterSet & iConfig);
    ~trilEWK(){};
