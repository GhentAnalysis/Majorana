...
#include "TAxis.h"
#include <iostream>
#include "Majorana/PatAnalyzer/interface/mcbtagSFuncert.h"
...
double mcbtagSFuncert::btagScaleFactor(double jetpt, std::string algo, bool useFastSim) {
    double SFb = 1.0;
...
double mcbtagSFuncert::btagScaleFactorError(double jetpt, std::string algo, bool useFastSim, SMSFastSim systType) {
    double SFerr_full = 0;
...
double mcbtagSFuncert::getMinBtagPt()  {return 40.;}
double mcbtagSFuncert::getMaxBtagEta() {return 2.4;}
//--------------------------------------------------------------------------
...
double mcbtagSFuncert::btagEff(double jetpt) {
    return 0.643;
}
//------------------------------------------------------------------------
...
double mcbtagSFuncert::btagEventWeight(int nbjets, double pt1, double pt2, double pt3, double pt4, 
                       bool useFastSim){
...
double mcbtagSFuncert::btagEventUncertainty(int nbjets, double pt1, double eta1, double pt2, double eta2, 
...
// (note: these do not need to be truth matched)
// Returns a negative number if something goes wrong
double mcbtagSFuncert::btagEventWeight3(int nbjets, double pt1, double pt2, double pt3, double pt4, bool useFastSim){
...
// eta3   = eta of the third  b quark
// eta4   = eta of the fourth b quark
double mcbtagSFuncert::btagEventUncertainty3(int nbjets, double pt1, double eta1, double pt2, double eta2, double pt3, double eta3, double pt4, double eta4,
                             bool useFastSim, SMSFastSim systType) {
    // protect against bad input values
    if (nbjets < 3 || nbjets > 4) {
