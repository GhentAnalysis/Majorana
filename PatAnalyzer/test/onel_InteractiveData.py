...
if isMC:
    ...
    *process.FakeElectrons
    ...
    #process.source.lumisToProcess = LumiList.LumiList(filename = '/localgrid/ikhvastu/CMSSW_7_4_14/src/Majorana/PatAnalyzer/test/JSON/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_Silver_v2.json').getVLuminosityBlockRange()
