...
#FakeElectrons
process.FakeElectrons = cms.EDAnalyzer("onel", #
                                       ...
                                       SampleName = cms.untracked.string("SingleLepton"), # defines a piece of code to run; helps to avoid code recompilation
...
if isMC:
    ...
    *process.FakeElectrons
    ...
    #process.source.lumisToProcess = LumiList.LumiList(filename = '/localgrid/ikhvastu/CMSSW_7_4_14/src/SUSYAnalyzer/PatAnalyzer/test/JSON/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_Silver_v2.json').getVLuminosityBlockRange()
